...
import FeaturesSection from '../../components/FeaturesWebsite/FeaturesSections';
import Visionsection from '../../components/VisitonSections/VisionSection';
import WebsiteLeistungen from '../../components/Leistungen/WebsiteLeistungen';
...
const Website = () => {
  ...
  const handleToggle = (index) => {
    ...
    <>
        <Head>
      <title>Professionelle Website Design & Entwicklung | the eksperts</title>
      ...
      <meta 
        name="description" 
        content="Moderne, skalierbare & SEO-optimierte Websites für Startups und KMUs. Gratis Website-Checkliste sichern!" 
      />
      <meta 
        name="keywords" 
        content="Website Design, Webentwicklung, SEO, Startups, KMUs, skalierbare Websites, digitale Lösungen" 
      />
      ...
      <meta 
        property="og:title" 
        content="Professionelle Website Design & Entwicklung | the eksperts" 
      />
      <meta 
      ...
      {/* Canonical URL */}
      <link rel="canonical" href="https://www.the-eksperts.com/services/website" />
    </Head>
