...
<section className="flex flex-col items-center text-center mb-[160px] lg:mb-[300px] mx-auto max-w-[1280px]">
      ...
      {/* Heading */}
      <h2 className="mt-4 text-[40px] leading-[48px] font-[700] text-black lg:block hidden">
      Ihr Leitfaden für eine leistungsstarke, sichere<br></br>
      und skalierbare Salesforce-ORG
      </h2>
      <h2 className="mt-4 text-[38px] leading-[48px] font-[700] text-black lg:hidden block">
      Ihr Leitfaden für eine leistungsstarke, sichere und skalierbare Salesforce-ORG
      </h2>
      ...
      <div className="grid grid-cols-1 gap-2 mt-8 lg:mt-[60px] md:grid-cols-2 lg:grid-cols-5">
        {[
          {
            icon: "/images/svg6.svg",
            title: "Performance Optimierung",
            description: "Beschleunigen Sie Seitenladezeiten, Abfragen und Automatisierungen."
          },
          {
            icon: "/images/svg5.svg",
            title: "Sicherheit & Compliance",
            description: "Stellen Sie korrekte Zugriffskontrollen und Datenintegrität sicher."
          },
          {
            icon: "/images/svg4.svg",
            title: "Prozessauto matisierung überprüfen",
            description: "Optimieren Sie Flows, Trigger und Apex-Code."
          },
          {
            icon: "/images/svg3.svg",
            title: "Skalierbarkeit & Wachstum",
            description: "Machen Sie Ihre Salesforce-Umgebung fit für zukünftige Expansionen."
          },
          {
            icon: "/images/svg2.svg",
            title: "Anpassungen & Best Practices",
            description: "Richten Sie Ihre Konfiguration an den Salesforce-Empfehlungen aus."
          }
        ].map((feature, index) => (
          <div key={index} className="flex flex-col items-left text-left px-6 py-8 rounded-[10px] border-[2px] border-black">
            ...
            <h3 className="mt-2 text-[24px] font-[900] leading-[32px] text-black uppercase">{feature.title}</h3>
  ...
  playsInline
>
  <source src="/images/the-eksperts-salesforce-video.mp4" type="video/mp4" />
  Your browser does not support the video tag.
    ...
    <section className="flex flex-col items-center mb-[160px] lg:mb-[300px] lg:flex-row max-w-[1280px] mx-auto">
      {/* Left Side - Image */}
      <div className="widthclass w-full lg:w-[750px] flex flex-col justify-center">
      <h2 className="text-[46px] font-bold text-black font-matt mb-[10px] lg:mb-[35px] lg:mt-4 leading-[56px] text-center lg:text-left lg:block hidden">
      Häufige Salesforce-Probleme,<br></br> die Zeit und Geld kosten
</h2>
<h2 className="text-[40px] font-bold text-black font-matt mb-[10px] lg:mb-[35px] lg:mt-4 leading-[56px] text-center lg:text-lef lg:hidden block">
      Häufige Salesforce-Probleme,die Zeit und Geld kosten
</h2>
      ...
      <div className="widthclass2 w-full lg:w-[528px] mt-6 lg:mt-0 ">
     

        <div className="mt-6 space-y-4">
          {[
            {
              icon: "/images/svg12.svg",
              title: "Langsame Performance",
              description: "Komplexe Automatisierungen, unoptimierte Berichte und ungenutzte Daten bremsen Ihr System aus."
            },
            {
              icon: "/images/svg13.svg",
              title: "Sicherheitsrisiken",
              description: "Zu weitreichende Berechtigungen und veraltete Zugriffskontrollen gefährden Ihre Daten."
            },
            {
            ...
            },
            {
              ...
              title: "Begrenzte Skalierbarkeit",
              description: "Schlechte Datenmodelle und übermässige Anpassungen verhindern zukünftiges Wachstum."
            },
            {
              icon: "/images/svg16.svg",
              title: " Datenchaos",
              description: "Duplikate, fehlende Felder und ungenaue Datensätze erschweren fundierte Entscheidungen."
            }
          ].map((issue, index) => (
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="981" height="834"  viewBox="0 0 981 837"
    fill="#626262"
    className="lg:block hidden absolute left-[60px] top-[5px] z-10">
...
Testimonials:
    ...
    Wir bauen, optimieren, reparieren<br></br> und verwalten alles!
    </p>
  </div>
  ...
  <div className="grid lg:grid-cols-4 grid-cols-1 gap-8 text-center">
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-[#000] text-[20px] lg:text-[24px] tracking-tight lg:leading-[32px] font-[300]">Steigung der Effizienz</p>
    </div>

    <div className="flex flex-col items-center gap-2 lg:mt-[-40px]">
    <p className="text-[#000] text-[20px] lg:text-[24px]  lg:leading-[32px] font-[300]">Bis zu</p>
      <h3 className="text-black font-[700] text-[80px] leading-[80px]">40%</h3>
      <p className="text-[#000] text-[20px] lg:text-[24px]  lg:leading-[32px] font-[300]">schnellere Salesforce-Operations</p>
    </div>
    ...
    <div className="flex flex-col items-center gap-2">
      <h3 className="text-black font-[700] text-[32px] leading-[40px]">Bessere Daten +<br></br> Bessere <br></br>Prozesse = Mehr<br></br> Sales!</h3>
    </div>
  </div>
</section>
  ...
  {reviews.map((review, index) => (
    ...
    >  
      ...
      <section className="lg:mt-[300px] mt-[160px] px-4 flex flex-col justify-center items-center gap-2 text-center text-black ">
            ...
            Holen Sie das Beste aus Ihrem<br></br> Salesforce-System heraus
            </h1>
            <h1 className="lg:hidden block font-matt lg:text-[80px] text-[45px] leading-[50px] font-bold lg:leading-[80px]">
            Holen Sie das Beste aus Ihrem Salesforce-System heraus
            </h1>
            
            {/* Body Text */}
            <p className="lg:block hidden font-matt text-[16px] lg:text-[20px] font-light leading-[28px] lg:leading-[33px]">
            Lassen Sie nicht zu, dass eine langsame, unoptimierte oder unsichere Salesforce-Umgebung Ihr<br></br> Unternehmen ausbremst. Laden Sie noch heute unseren Health-Check-Leitfaden herunter und erhalten Sie<br></br> wertvolle Einblicke, um Performance, Sicherheit und Effizienz zu verbessern.                </p>
            <p className="lg:hidden block font-matt text-[16px] lg:text-[20px] font-light leading-[28px] lg:leading-[33px]">
            Lassen Sie nicht zu, dass eine langsame, unoptimierte oder unsichere Salesforce-Umgebung Ihr Unternehmen ausbremst. Laden Sie noch heute unseren Health-Check-Leitfaden herunter und erhalten Sie wertvolle Einblicke, um Performance, Sicherheit und Effizienz zu verbessern.  </p>
            {/* Button */}
