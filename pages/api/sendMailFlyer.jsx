...
export default async function handler(req, res) {
    if (req.method === 'POST') {
        ...
        const { vornamenachname, unternehmen, email, telephone } = req.body;

        // Validate the incoming data
        if (!vornamenachname || !unternehmen || !email || !telephone) {
        ...
        try {
            ...
            const emailResponse = await axios.post(
                ...
                {
                    message: {
                        subject: `New Form Submission from Srping Flyer Landing Page:`,
                        body: {
                            contentType: 'Text',
                            content: `You have received a new form submission:\n\nFull Name: ${vornamenachname} \nEmail: ${email}\nCompany: ${unternehmen}\nTelephone: ${telephone}`,
                        },
                        toRecipients: [
                            {
                                emailAddress: {
