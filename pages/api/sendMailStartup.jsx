...
const sendEmailWithPDF = async (recipientEmail, vorname) => {
    try {
        ...
        const pdfPath = path.resolve('./public/Ihr KMU Guide.pdf'); // Adjust the path accordingly
...
const { vorname, nachname, email, unternehmen, position } = req.body;
        ...
        try {
            ...
            await axios.post(
                ...
                {
                    message: {
                        subject: `New Form Submission From Website Services for Startups PDF Form`,
                        body: {
                            contentType: 'Text',
