        ...
        <section className="lg:mb-[240px] mb-8">
            ...
            <section className='lg:mb-[300px] mb-8'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Image 1 */}
                    <div
                    className="flex items-center justify-center w-full h-[350px] lg:w-[621px] lg:h-[557px] rounded-[20px]"
                    ...
                    {/* Contact Form */}
                    <div className="flex justify-center items-center lg:w-[621px] lg:h-[557px] bg-[#0009FF] rounded-[20px]">
                    <form className="w-full max-w-lg p-4 text-center">
                    <h3 className="text-white text-[28px] font-matt font-extrabold leading-[37px] uppercase lg:mb-10 mb-2">
                        YOU WANT TO START A PROJEKT?
                    </h3>

                    <div className="flex items-center lg:justify-between justify-center space-x-8 w-[370px] h-[58px] p-2 rounded-lg mb-4 mt-4">
                        <label className="text-white font-matt text-[20px] font-light">
                            Services
                        </label>
                        <select className="lg:w-[400px] p-2 lg:ml-[40px] rounded-lg text-black text-[20px] font-light">
                    ...
                    <div className="flex items-center lg:justify-between justify-center space-x-8 w-[370px] h-[58px] p-2 rounded-lg mb-4 mt-4">
                        ...
                        <select className="lg:w-[400px] p-2 lg:ml-[40px] rounded-lg text-black text-[20px] font-light">
                          ...
                          <button className='md:mt-10 mt-2'>
                          <svg className="lg:w-[350px] w-[250px]" viewBox="0 0 369 44" fill="none" xmlns="http://www.w3.org/2000/svg">
