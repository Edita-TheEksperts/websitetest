  ...
  return (
    <>
      ...
      <main className="max-w-[1330px] mx-auto px-4 sm:px-6 lg:px-8 mb-[100px] box-border overflow-x-hidden">
        ...
        <section className="mb-12 lg:mb-[40px] text-left">
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 mt-5 mb-5 items-stretch">
              ...
              {/* LESENSWERT */}
          <LesenswertBox currentSlug="website-baukaesten-schweiz" />
            </div>
          </div>
        </section>
        ...
        {/* Why Nearshoring */}
        <section className="mb-12 bg-white p-6 lg:p-8 rounded-[12px] shadow-md">
          ...
          <p className="text-black font-[300] text-[16px] lg:text-[20px] font-matt leading-relaxed mb-6">
            ...
            erstellen, ist verlockend. Plattformen wie Wix, Jimdo oder Editor X
            haben den Markt mit dem Versprechen revolutioniert, dass jeder seine
            eigene Website gestalten kann. Sie bieten eine intuitive
        ...
        <section className="mb-12 flex flex-col lg:flex-row gap-12">
          {/* Text Section */}
          <div className="lg:w-[60%]">
            <img
              src="/images/sentilink.png"
          ...
          <div className="lg:w-[40%] mb-8 lg:mb-0">
            ...
            <ul className="list-disc ml-6 space-y-6 text-black font-[300] text-[16px] lg:text-[20px] lg:leading-[33px] font-matt">
              <li>
                <strong>Einfache Handhabung:</strong> Der grösste Pluspunkt ist
                die Benutzerfreundlichkeit. Sie können per Drag-and-Drop
                Elemente auf Ihrer Seite anordnen, Texte hinzufügen und Bilder
                hochladen.{" "}
              </li>
              <li>
                <strong>Schneller Start:</strong> Innerhalb weniger Stunden oder
                Tage können Sie eine grundlegende Online-Präsenz aufbauen.{" "}
              </li>
              <li>
                <strong>Niedrige Einstiegskosten:</strong> Die monatlichen
                Abo-Gebühren sind oft überschaubar, was sie für Kleinunternehmen
                und Startups attraktiv macht, die ein sehr begrenztes Budget
                haben. <br />{" "}
                <Link
        ...
        <section className="mt-12 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-12 bg-white p-6 lg:p-8 rounded-[12px] shadow-md">
          ...
          <Link href="/kontakt" passHref legacyBehavior>
            <a className="bg-[#0009FF] text-white text-[16px] lg:text-[18px] font-medium rounded-full px-8 py-4 shadow-md hover:bg-blue-700 transition-all inline-block whitespace-nowrap text-center">
              Sprich mit uns
            </a>
          </Link>
        </section>
        ...
        <section className="mb-12 mt-5 relative bg-white p-8 lg:p-12 rounded-[16px] shadow-xl space-y-8 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="lg:w-1/2 space-y-6 bg-white/70 p-6 rounded-[12px] shadow-md">
              ...
              <ul className="list-disc ml-6 space-y-3 text-black font-[300] text-[16px] lg:text-[20px] font-matt">
                ...
                <li>
                  Sie spezifische Funktionen benötigen, die der Baukasten nicht
                  von Haus aus bietet.
                </li>
                <li>Sie Ihre Website für Suchmaschinen optimieren möchten.</li>
                <li>
            ...
            <div className="lg:w-1/2 flex justify-center items-center">
              <img
                src="/images/2_Website Baukästen für Einsteiger Was geht, was nicht.svg"
                alt="2_Website Baukästen für Einsteiger Was geht, was nicht"
        ...
        <section className="w-full px-4 py-[60px] flex justify-center">
          <div className="max-w-[900px] w-full text-center">
            ...
            <p className="text-[16px] lg:text-[20px] text-black font-matt font-[300] leading-[1.8]">
              ...
              Startlösung sein. Sobald jedoch Professionalität, Individualität,
              Skalierbarkeit und Sichtbarkeit im Vordergrund stehen, ist die
              Beauftragung einer professionellen Webagentur, die Ihnen eine
              massgeschneiderte Website erstellen kann, die nachhaltigere und
              oft auch kosteneffizientere Wahl auf lange Sicht.{" "}
            </p>
