      ...
      <main className="max-w-[1330px] mx-auto px-4 sm:px-6 lg:px-8 py-8 mb-[100px]">
          ...
          <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-8 mt-6">
              ...
              <div className="bg-[#0009FF] rounded-[8px] p-5 lg:p-6 w-full">
                ...
                <p className="text-white font-[300] text-[16px] sm:text-[18px] lg:text-[20px] font-matt leading-relaxed">
        ...
        <section>
          ...
          <section className="w-full mb-20">
            <h2 className="text-[28px] sm:text-[30px] lg:text-[36px] font-matt font-[900] text-black text-center mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border border-[#0009FF] bg-white rounded-[16px] p-6 shadow-md">
                <h3 className="text-[22px] sm:text-[24px] font-[800] text-[#0009FF] mb-4 font-matt">
                  Was bedeutet UX?
                </h3>
                <p className="text-black font-matt font-[300] text-[16px] sm:text-[17px] lg:text-[20px] leading-[1.8]">
          ...
          <section className="lg:w-[990px] space-y-[30px] mx-auto px-4 sm:px-6 lg:px-0">
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white overflow-hidden flex flex-col lg:flex-row gap-6 rounded-[12px]">
                <div className="lg:w-[60%] w-full px-4 sm:px-6 lg:px-0 mx-auto">
                  <h2 className="text-[28px] sm:text-[30px] font-matt font-[900] text-black mb-4 uppercase text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white overflow-hidden flex flex-col lg:flex-row rounded-[12px] gap-6">
                <div className="flex flex-col justify-center lg:w-[60%] w-full px-4 sm:px-6 lg:px-0">
                  <h2 className="text-[28px] sm:text-[30px] font-matt font-[900] text-black mb-4 uppercase text-center lg:text-left">
                    Höhere Conversion Rates:
                  </h2>
                  <p className="list-disc ml-0 lg:ml-6 space-y-4 text-black font-[300] text-[16px] sm:text-[18px] lg:text-[20px] font-matt leading-relaxed text-center lg:text-left">
                ...
                <div
                  className="lg:w-[50%] w-full h-[240px] bg-cover bg-center rounded-[12px] flex justify-center items-center"
                  style={{
                    background:
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white overflow-hidden flex flex-col lg:flex-row-reverse rounded-[12px] gap-6">
                <div className="flex flex-col justify-center lg:w-[60%] w-full px-4 sm:px-6 lg:px-0">
                  <h2 className="text-[28px] sm:text-[30px] font-matt font-[900] text-black mb-4 uppercase text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white overflow-hidden flex flex-col lg:flex-row rounded-[12px] gap-6">
                <div className="flex flex-col justify-center lg:w-[60%] w-full px-4 sm:px-6 lg:px-0">
                  ...
                  <p className="text-black font-[300] text-[16px] sm:text-[18px] lg:text-[20px] font-matt leading-relaxed text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white overflow-hidden flex flex-col lg:flex-row-reverse rounded-[12px] gap-6">
                ...
                <div
                  className="lg:w-[50%] w-full h-[270px] bg-cover bg-center rounded-[12px] flex justify-center items-center"
                  style={{
                    background:
        ...
        <div className="mb-16 lg:w-[905px] mx-auto px-4 sm:px-6 lg:px-0">
          <h2 className="text-[28px] sm:text-[30px] font-matt font-[900] text-black mb-4 uppercase mt-12">
            Der Prozess: Wie wir Ihr Website Konzept erstellen
          </h2>

          <p className="text-black text-[16px] sm:text-[18px] lg:text-[20px] font-[300] font-matt mb-4 leading-relaxed">
          ...
          <ul className="list-disc ml-6 text-black text-[16px] sm:text-[18px] lg:text-[20px] font-[300] font-matt space-y-3 leading-relaxed">
            <li>
          ...
          <div className="mt-6">
            <a
              href="#contact"
              className="inline-block bg-[#0009FF] text-white text-[16px] lg:text-[20px]  sm:text-[18px] font-matt font-[600] px-6 py-3 rounded-full shadow-md hover:bg-[#1a1aff] transition duration-300"
            >
        ...
        <section className="w-full px-4 py-[60px] flex justify-center">
          <div className="max-w-[900px] w-full text-center">
            ...
            <h2 className="text-[24px] sm:text-[28px] lg:text-[32px] font-matt font-[800] text-black mb-6">
              Fazit: UX/UI als Erfolgsfaktor
            </h2>

            <p className="text-[16px] sm:text-[18px] lg:text-[20px] text-black font-matt font-[300] leading-[1.8]">
            ...
            <p className="text-black text-[16px] sm:text-[18px] lg:text-[20px] font-[300] font-matt mt-6 text-center">
              <strong>
