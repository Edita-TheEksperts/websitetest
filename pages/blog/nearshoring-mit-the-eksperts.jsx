...
const KosovaPost = () => {
  ...
  <div className="text-left ">
    ...
    <h3 className="lg:block hidden lg:text-[40px] text-[25px] font-matt font-[400] lg:leading-[48px]" style={{fontFamily: 'Matt_Trial', color: '#000'}}>
      So profitieren Unternehmen von digitalen Teams aus dem <br></br> DACH-Raum und dem Balkan mit Book Your Eksperts
    </h3>
...
<h2 className="text-[28px] font-matt text-white mb-4 uppercase">
  ...
  <span className="font-300">(too long; didn't read)</span>
    ...
    <p className="text-white font-[300] text-[16px] lg:text-[20px] font-matt">
      Nearshoring ist der smarte Mittelweg zwischen Inhouse und Offshoring. Mit the eksperts erhalten Unternehmen Zugriff auf erfahrene Entwickler, Designer, Salesforce-Spezialisten und Projektleiter aus dem DACH-Raum und dem Westbalkan – kosteneffizient, flexibel und auf Augenhöhe.</p>
    </div>
        ...
        <section>
          <div className="mb-10">
            <img
              src="/images/kosovap.png" // Replace with actual image path
              alt="Kosova"
  ...
  <h2 className="text-[28px] font-matt font-[900] text-black mb-4 uppercase">Warum Nearshoring mit the eksperts?</h2>
    ...
    <li>Agile Prozesse & europäische Standards</li>
  </ul>
          </div>
