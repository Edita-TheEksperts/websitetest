      ...
      <main className="max-w-[1330px] mx-auto p-2 lg:p-8 mb-[100px]">
        ...
        <section>
          <section className="relative bg-gradient-to-br from-blue-100 via-blue-200 to-blue-100 py-28 px-4 flex justify-center overflow-hidden">
            <div className="absolute left-0 top-[50%] -translate-y-1/2 z-0 opacity-30 blur-sm">
              <svg
            ...
            <div className="relative z-10 max-w-[1200px] w-full flex flex-col lg:flex-row items-center gap-10">
              ...
              <div className="w-full lg:w-[60%] bg-white/40 backdrop-blur-md border border-white/20 rounded-3xl shadow-xl p-8 lg:p-10 text-neutral-900">
                ...
                <p className="text-[17px] lg:text-[19px] leading-relaxed font-matt mb-6">
                  ...
                  innovativen digitalen Lösungen suchen. Um in diesem
                  dynamischen und wettbewerbsintensiven Umfeld erfolgreich zu
                  sein, ist eine erstklassige Online-Präsenz unerlässlich.
                </p>

                <p className="text-[17px] lg:text-[19px] leading-relaxed font-matt">
                  Eine professionelle Website Zürich, ein leistungsfähiger
                  Online Shop Zürich oder eine massgeschneiderte App Entwicklung
                  Zürich sind der Schlüssel, um Ihre Zielgruppe direkt zu
                  erreichen und Ihre Marke wirkungsvoll zu präsentieren.
                </p>
              </div>
            </div>
          </section>
        ...
        <section>
          ...
          <section className="bg-gradient-to-br from-[#f0f6ff] via-white to-[#e6eefc] py-12 px-4 flex justify-center">
            <div className="max-w-[1200px] w-full bg-white shadow-2xl rounded-3xl p-10 lg:p-16">
              ...
              <p className="text-[17px] lg:text-[19px] leading-relaxed font-matt">
                ...
                Ihr Partner für eine breite Palette an Dienstleistungen: <br />{" "}
                <br />{" "}
              </p>
              {/* Content List */}
              <ul className="text-[17px] lg:text-[19px] text-neutral-800 font-matt space-y-6 list-disc pl-6">
                <li>
                  <strong>
                ...
                <li>
                  ...
                  <ul className="list-disc ml-6 mt-2 space-y-2">
                    ...
                    <li>
                      <strong>Online Shop Zürich / Webshop Zürich:</strong>{" "}
                      Aufbau und Optimierung von E-Commerce-Plattformen, um Ihre
                      Produkte und Dienstleistungen im Zürcher Markt und darüber
                      hinaus erfolgreich zu verkaufen.
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      Steigern Sie Ihre Sichtbarkeit und Reichweite durch
                      gezielte Marketingkampagnen und Suchmaschinenoptimierung.
                      <Link
                ...
                <li>
                  <strong>Persönlicher Austausch:</strong> Ob bei uns im Büro
                  mit Blick auf die Sihl, per Video-Call oder direkt bei Ihnen
                  vor Ort – wir legen Wert auf eine enge und partnerschaftliche
                  Zusammenarbeit.
                </li>{" "}
              </ul>
            </div>
          ...
          <section className="relative bg-gradient-to-br from-blue-950 via-blue-900 to-sky-900 py-24 px-6 overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full pointer-events-none z-0">
              <svg
                className="absolute top-[-80px] left-[-100px] opacity-10 w-[500px] h-[500px]"
                viewBox="0 0 24 24"
                fill="none"
                stroke="url(#gradSvg)"
                strokeWidth="1.2"
            ...
            <div className="relative z-10 max-w-6xl mx-auto bg-white/90 backdrop-blur-sm border border-white/20 rounded-3xl shadow-2xl p-10 lg:p-16 text-gray-900">
              ...
              <p className="text-[17px] lg:text-[19px] font-matt leading-relaxed mb-6">
                Unser Fokus liegt darauf, digitale Lösungen zu schaffen, die
                nicht nur beeindrucken, sondern auch messbare Ergebnisse für Ihr
                Business in Zürich liefern:
              </p>

              <ul className="list-disc pl-6 text-[17px] lg:text-[19px] font-matt space-y-4 mb-6">
                <li>
                ...
                <li>
                  ...
                  <span className="underline text-blue-500">
                    ...
                    >
                      ...
                      Erfolg im Zeitalter des Smartphone
                    </Link>
                  </span>
                </li>
              </ul>
              <div className="text-center mt-10">
                <Link href="/kontakt" passHref legacyBehavior>
                  <a className="bg-blue-800 hover:bg-blue-700 text-white font-matt text-[16px] lg:text-[18px] px-8 py-4 rounded-full shadow-md transition duration-300">
