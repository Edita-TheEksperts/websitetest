      ...
      <main className="max-w-[1330px] mx-auto p-2 lg:p-8 mb-[100px]">
        ...
        <section>
          ...
          <section className="flex justify-center mb-20 px-4">
            <div className="max-w-[1100px] w-full flex flex-col lg:flex-row-reverse gap-[40px]">
              {/* Image with dynamic shape */}
              ...
              {/* Text Content */}
              <div className="lg:w-[50%] bg-gradient-to-bl from-white via-[#F5F8FF] to-white p-8 rounded-[20px] shadow-md flex flex-col justify-center">
                <h2 className="text-[28px] lg:text-[32px] font-matt font-[900] text-black mb-4 leading-snug">
          ...
          <section className="w-full max-w-[1100px] mx-auto px-4 mt-[80px] mb-[80px]">
            ...
            <p className="text-black text-[16px] lg:text-[16px] font-[300]  mt-20 font-matt italic">
              <em>
          ...
          <section className="w-full mb-20 flex flex-col items-center px-4">
            <div className="w-full max-w-[1200px] p-6 lg:p-[60px] rounded-[24px] bg-gradient-to-br from-white via-[#F8F9FF] to-white shadow-xl">
              <h2 className="text-[28px] lg:text-[40px] font-matt font-[900] text-center text-black uppercase mb-12 leading-tight">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 mb-8 items-stretch">
                {[
                  ...
                  >
                    <h3 className="text-[20px] font-[800] text-black mb-3 relative pb-2">
                      {item.title}
                    ...
                    <p className="text-black font-[300] text-[16px] lg:text-[18px] leading-[1.7] font-matt">
                      {item.text}
                    </p>
                  </div>
                ))}
