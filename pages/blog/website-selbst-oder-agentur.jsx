      ...
      <main className="max-w-[1330px] mx-auto p-2 lg:p-8 mb-[100px]">
        ...
        <section className="mb-[16px]  lg:mb-[40px] text-left">
          <div className="text-left ">
            <h1 className="font-matt text-[30px] lg:text-[53px] leading-[1] font-semibold uppercase text-gray-900 tracking-tight">
              Website selbst erstellen oder Agentur beauftragen? Der grosse
        ...
        <section>
          ...
          <section className="mb-[60px] lg:mb-[80px] text-center">
            <div className="mt-[15px] bg-[#0009FF] rounded-[8px] p-[30px] lg:w-[1300px] mx-auto mb-12 text-center">
              <h2 className="text-[25px] font-matt text-white mb-4 uppercase">
                <strong>Option 1: Website selbst erstellen (DIY)</strong>
              </h2>
              <p className="text-white font-[300] text-[16px] lg:text-[20px] font-matt">
          ...
          <section className="mb-12 flex flex-col lg:flex-row gap-[57px]">
            ...
            <div className="lg:w-[50%] mb-8 lg:mb-0">
              ...
              <ul className="list-disc ml-6 space-y-6 text-black font-[300] text-[16px] lg:text-[20px] lg:leading-[33px] font-matt">
                ...
                <li>
                  <strong> Schneller Start: </strong>Mit Baukastensystemen{" "}
                  <br />
                  <Link
          ...
          <section className="flex flex-col lg:flex-row items-center gap-8 mb-12">
            <div className="lg:w-[50%]">
              <h2 className="text-[28px] font-matt font-[900] text-black mb-2 uppercase mt-16">
                Nachteile:
              </h2>
        ...
        <section className="mb-[60px] lg:mb-[80px] text-center">
          <div className="mt-[15px] bg-[#0009FF] rounded-[8px] p-[30px] lg:w-[1300px] mx-auto mb-12 text-center">
            <h2 className="text-[25px] font-matt text-white mb-4 uppercase">
              <strong>
                Option 2: Website erstellen lassen Agentur beauftragen{" "}
              </strong>
            </h2>
            <p className="text-white font-[300] text-[16px] lg:text-[20px] font-matt">
        ...
        <p className="text-black font-[300] text-[17px] lg:text-[17px] font-matt">
          <em>
            [Bildvorschlag: Eine Gruppe von Fachleuten (Webdesigner, Entwickler)
            in einem Meeting, die ein Website-Projekt besprechen.]{" "}
          </em>{" "}
        </p>
        <section className="mt-16 border border-gray-300 rounded-[12px] py-10 px-6 flex flex-col lg:flex-row items-center justify-between gap-6">
          <div>
            ...
            <p className="text-[16px] lg:text-[18px] font-matt font-[300] text-gray-700">
          ...
          <Link href="/kontakt" passHref legacyBehavior>
            <a className="bg-[#0009FF] text-white text-[16px] lg:text-[18px] font-medium rounded-full px-6 py-3 hover:bg-blue-700 transition">
        ...
        <section className="mb-12 lg:w-[950px] mx-auto space-y-10 bg-gradient-to-br from-white via-gray-50 to-white shadow-xl rounded-[16px] p-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
            <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition">
              ...
              <ul className="list-disc ml-6 text-black font-[300] text-[16px] lg:text-[18px] space-y-2">
                <li>
          ...
          <p className="text-black font-[300] text-[16px] lg:text-[20px] font-matt mt-8 text-center">
          ...
          <div className="text-center mt-8">
            <Link href="/kontakt" passHref legacyBehavior>
              <a className="bg-[#0009FF] text-white text-[16px] lg:text-[18px] font-medium rounded-full px-8 py-3 hover:bg-blue-700 transition shadow-md inline-block">
