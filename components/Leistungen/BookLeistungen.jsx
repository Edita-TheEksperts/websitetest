          ...
          >
            ...
            <div className="flex-shrink-0 ">
              <img
                src={feature.image}
                alt={feature.title}
                className="w-[332px] h-auto lg:h-[220px] lg:w-[220px]"
              />
            </div>

            {/* Text Section */}
            <div className="lg:ml-6 lg:w-2/3 text-left flex flex-col justify-start items-start h-full mt-6 lg:mt-0">
                <h3 className="text-black font-matt font-[900] text-[18px] lg:text-[26px] lg:leading-[37px] uppercase mb-2">
                    {feature.title}
                </h3>
                <p className="text-black font-matt text-[16px] font-[300] lg:leading-[30px] lg:w-[230px]">
                    {feature.description}
                </p>
                </div>
          </div>
