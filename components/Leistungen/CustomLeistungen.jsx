      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-12">
        {features.map((feature) => (
          ...
          >
            ...
            {/* Text Section */}
            <div className="lg:ml-6 lg:w-2/3 text-left flex flex-col justify-start items-start h-full mt-[24px] lg:mt-0">
                <h3 className="text-black font-matt font-[900] text-[20px] lg:text-[28px] lg:leading-[37px] uppercase mb-2">
                    {feature.title}
                </h3>
                <p className="text-black font-matt text-[16px] font-[300] lg:leading-[33px] lg:w-[280px]">
                    {feature.description}
                </p>
                </div>
          </div>
