...
export default function FeatureSection() {
  return (
    <div className="bg-white py-2 lg:px-0 max-w-[1280px] mx-auto">
          ...
          >
            ...
            <div className="flex-shrink-0 ">
              <img
                src={feature.image}
                alt={feature.title}
                className="max-w-full h-auto lg:h-[220px] lg:w-[220px]"
              />
            </div>

            {/* Text Section */}
            <div className="lg:ml-6 lg:w-2/3 text-left flex flex-col justify-start items-start h-full mb-8 md:mb-0">
                <h3 className="text-black font-matt font-[900] text-[18px] lg:text-[26px] lg:leading-[37px] uppercase mb-2 mt-6 md:mt-0">
                    {feature.title}
                </h3>
