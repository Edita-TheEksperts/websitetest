    ...
    >
      <motion.div 
        style={{
          ...
          top: `calc(-5vh + ${i * 25}px)` // Assuming i is an index variable or number
        }}
        
        className={styles.card}
      >
        <h2 className={`font-matt flex items-start text-left text-[36px] lg:text-[62px] font-[700] lg:leading-[80px] md:mt-[10px] ${textColorClass}`}>{title}</h2>
        <div className={styles.body}>
          <div className={styles.description} >
          <p className={`text-black mb-8 font-matt font-[700] text-[18px] md:mt-6 lg:mt-0 lg:text-[20px] leading-[28px] lg:leading-[33px] ${textColorClass}`}>{title1}</p>
          
            <p className={`text-black mb-8 font-matt text-[14px] leading-[25px] lg:text-[18px] font-[300] lg:leading-[33px] ${textColorClass}`}>{description}</p>
            <p className={`text-black mb-8 font-matt font-[700] text-[18px] lg:mt-0 lg:text-[20px] leading-[28px] lg:leading-[33px] ${textColorClass}`}>{title2}</p>
            <span>
