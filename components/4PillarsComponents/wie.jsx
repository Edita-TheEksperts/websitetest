...
const HeaderSection = () => {
  ...
  return (
    <div
      ref={ref}
      className="sticky top-0 flex flex-col items-center justify-center lg:mt-0 mt-[200px] lg:mb-0 mb-[200px] lg:h-screen bg-white transition-opacity duration-700 z-50"
    >
      <motion.h2
