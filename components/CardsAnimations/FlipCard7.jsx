...
export default function FlipCard7() {
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
              background: "radial-gradient(50% 50% at 50% 50%, rgba(0, 0, 0, 0.00) 0%, rgba(0, 0, 0, 0.40) 100%), url('/images/Alters-ProjektePage.png') lightgray center center / cover no-repeat",
...
<svg xmlns="http://www.w3.org/2000/svg" width="131" height="17" viewBox="0 0 131 17" fill="none">
  <path d="M0 17V6.5L8.5 0H131V17H0Z" fill="url(#paint0_linear_2696_2968)"/>
  <defs>
    <linearGradient id="paint0_linear_2696_2968" x1="0" y1="8.5" x2="131" y2="8.5" gradientUnits="userSpaceOnUse">
      <stop offset="0.9399" stop-color="#0009FF"/>
      <stop offset="0.94" stop-color="#D9D9D9"/>
          ...
          >
            <div className="flex flex-col absolute inset-0 bg-[#83B328] justify-center items-center px-10 space-y-6">
              <h2
