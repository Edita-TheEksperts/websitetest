...
export default function FlipCard() {
  ...
  return (
    <div className="flex mb-[32px]">
      <div
        className="flipcard relative w-[390px] h-[557px] md:w-[750px] md:h-[557px] lg:w-[480px] lg:h-[557px] perspective-1000 cursor-pointer"
        onClick={() => {
          if (!isMobile) {
            setFlipped(!flipped);
          }
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{
                background: "radial-gradient(50% 50% at 50% 50%, rgba(0, 0, 0, 0.00) 0%, rgba(0, 0, 0, 0.40) 100%), url('/images/the-eksperts-MobileZoneFinal2.png') lightgray center center / cover no-repeat",
          ...
          >
            ...
            <div className="absolute top-6 left-6 z-10">
              ...
              >
                System & Cloud <br></br> Engineering
              </p>
              <p
            ...
            <h2 className="text-start text-[14px] lg:text-[20px] font-[300] font-matt leading-[33px] md:ml-[8px]">Project Completed, Currently: Optimizing</h2>
          ...
          >
            <div className="flex flex-col absolute inset-0 bg-[#FF0000] justify-center items-center px-10 space-y-6">
              <h2
