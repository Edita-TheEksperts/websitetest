...
const handleSubmit = async (e) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-center text-center text-3xl md:text-5xl lg:text-[90px] md:leading-[60px] lg:leading-[90px] font-[700] font-matt space-y-0 p-2 lg:p-12">
          <div className="flex items-center justify-center space-x-0">
            <p>Vielen Dank!</p>
            <video
              className="w-[40px] h-[40px] lg:w-auto lg:h-[110px]"
              autoPlay
              muted
              loop
              playsInline
               ...
               <button
                  ...
                  >
                    ...
                    <div className="flex flex-col lg:flex-col items-center justify-between space-y-6 lg:space-y-0 lg:space-x-4 md:mb-[10px]">
                      ...
                      <h2 className="text-[16px] font-[900] text-center uppercase md:text-[22px] md:leading-[27px] font-matt mb-4">
                      Wir nehmen uns die Zeit, Ihr Projekt und Ihre Anforderungen zu verstehen.
                        </h2>
                        <p className="text-black mb-4 text-center lg:text-[18px] text-[14px] font-matt leading-[28px]">
                              ...
                              <form className="space-y-4 font-matt md:mb-[10px]">
                                <div className="grid grid-rows-1 md:grid-rows-2 gap-4 mb-8 font-matt">
                                  ...
                                  <div className="flex md:justify-start justify-center mt-2">
                                    ...
                                    <div className="flex md:justify-start justify-center lg:ml-3">
